  ...
  const teamMembers = [
    {
      ...
      description: 'Với hơn 10 năm kinh nghiệm trong ngành du lịch, anh A đã xây dựng Vi Vu Tour từ một công ty nhỏ thành một trong những đơn vị lữ hành hàng đầu tại Tây Ninh.',
    },
    {
      id: 2,
      name: 'Trần Thị B',
          ...
          <Row gutter={[48, 48]} align="middle">
            <Col xs={24} md={12}>
              <div className="about-image">
                <img src="/images/about/about-company.jpg" alt="Vi Vu Tour" />
              </div>
            </Col>
            <Col xs={24} md={12}>
